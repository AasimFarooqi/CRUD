    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 mt-16">
        ...
        <form method="POST" action="{{ route('tasks.store') }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                @if ($errors->has('title') || $errors->has('description') || $errors->has('priority') || $errors->has('date'))
                @if(!$errors->has('image'))
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <small class="text-sm text-gray-600">{{ Carbon\Carbon::parse($task->created_at)->format('h:i:s a m/d/Y') }}</small>
